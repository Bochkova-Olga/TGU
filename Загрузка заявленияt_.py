...
class Test():
  ...
  def test_(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".form:nth-child(3) .document-tile:nth-child(2) > .document-status").click()
    self.vars["window_handles"] = self.driver.window_handles
    self.driver.find_element(By.LINK_TEXT, "Скачать").click()
    self.vars["win2487"] = self.wait_for_window(2000)
    self.vars["root"] = self.driver.current_window_handle
    self.driver.switch_to.window(self.vars["win2487"])
    self.driver.close()
    self.driver.switch_to.window(self.vars["root"])
    self.driver.find_element(By.CSS_SELECTOR, ".file:nth-child(2) > .delete").click()
